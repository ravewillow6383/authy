...
@bp.route('/creature/<int:id>', methods=['GET'])
@token_auth.login_required
def one_creature(id):
...
@bp.route('/creature', methods=['POST'])
@token_auth.login_required
def create_creature():
...
@bp.route('/creature/<int:id>', methods=['PUT'])
@token_auth.login_required
...
@bp.route('/creature/<int:id>', methods=['DELETE'])
@token_auth.login_required
